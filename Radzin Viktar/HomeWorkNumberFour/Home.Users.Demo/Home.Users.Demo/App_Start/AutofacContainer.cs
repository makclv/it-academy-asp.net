...
namespace Home.Users.Demo.App_Start
{
    public class AutofacContainer
    {
        public static void Register()
        {
            ...
            builder.RegisterType<UserDbContext>().As<IUserDbContext>().InstancePerRequest();
            ...
            builder.RegisterAssemblyTypes(typeof(IUserDomainService).Assembly)
              .Where(t => typeof(IUserDomainService).IsAssignableFrom(t))
              .AsImplementedInterfaces()
              .InstancePerDependency();
            builder.RegisterType<UserRepository>().As<IUserRepository>().AsImplementedInterfaces().InstancePerDependency();
